...
<svelte:head>
  ...
  <meta name="description" content="Mitra profesional untuk perbaikan, renovasi, arsitektur, interior, dan eksterior di Bandung." />
</svelte:head>
...
<PublicShell>
  <main id="content">
    <section class="page-shell grid gap-10 py-16 sm:py-20 lg:grid-cols-[0.7fr_1.3fr] lg:gap-16 lg:py-28">
      ...
      <div><h1 class="page-title">Mitra profesional untuk ruang yang kokoh, presisi, dan estetis.</h1><p class="mt-8 max-w-3xl text-xl leading-8 text-forest">HD Karya Bandung adalah mitra profesional untuk perbaikan, renovasi, pekerjaan arsitektur, serta penataan interior dan eksterior di Kota Bandung dan sekitarnya. Kami membantu merawat, memperbaiki, dan mempercantik hunian, kantor, maupun tempat usaha.</p></div>
    </section>
